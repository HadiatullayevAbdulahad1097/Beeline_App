...
import developer.abdulaziz.navigate.Utils.*
import developer.abdulaziz.navigate.adapter.TariflarAdapter
import developer.abdulaziz.navigate.adapter.HizmatlarAdapter
import developer.abdulaziz.navigate.adapter.InternetAdapter
import developer.abdulaziz.navigate.adapter.SmsAdapter
import developer.abdulaziz.navigate.databinding.FragmentHizmatlarBinding
import kotlinx.android.synthetic.main.fragment_hizmatlar.*
import kotlinx.android.synthetic.main.fragment_home.*
import kotlinx.android.synthetic.main.hizmatlar_item.*
import kotlinx.android.synthetic.main.internet_item.*
import kotlinx.android.synthetic.main.sms_item.*
import kotlinx.android.synthetic.main.tariflar_item.*
import java.net.URL
    ...
    override fun onCreateView(
        ...
        when(Sanoq.raqam) {
            ...
            2 ->{
                ...
                list2.add(User2("1 gb"," *1*1#", "10.000 sum","- Oylik Internet-paketlarning amal qilish muddati paket yoqtirilgan kundan boshlab 30 kunni tashkil etadi. Internet-paket ulangan kundan boshlab 30 kun o'tgach yangi internet-paket yoqtirilmasa, ishlatilmagan trafik qoldig’i kuyadi.\n" +
                ...
                list2.add(User2("2 gb", "*1*2#","15.000 sum","- Oylik Internet-paketlarning amal qilish muddati paket yoqtirilgan kundan boshlab 30 kunni tashkil etadi. Internet-paket ulangan kundan boshlab 30 kun o'tgach yangi internet-paket yoqtirilmasa, ishlatilmagan trafik qoldig’i kuyadi.\n" +
                        "- Internet-paketning amal qilish muddati davomida yana qo'shimcha paket xarid qilinsa, barcha sarflanmagan trafik hajmi qo'shilib, amal qilish muddati oxirgi yoqtirilgan paket kunidan boshlab 30 kunga uzaytiriladi.\n" +
                        "- Taqdim etilgan trafik tugaganida yoki paket muddati yakunlanganda, internet-trafikning keyingi sarflanishi tarif rejangiz shartlariga muvofiq narxlanadi.\n" +
                        "- Raqam faol bo’lmagan yoki blok holatiga tushirilgan davrda oxirgi ulangan internet paketning amal qilish muddati o’zgarmaydi.\n" +
                        "- Shuni ma’lum qilamizki, internet trafik, daqiqa va SMSlar qoldig’i va boshqa qo’shimcha xizmatlar bo’yicha ma’lumoti 06:00 dan 00:00 gacha yuboriladi.\n" +
                        ...
                        "- Oylik internet paketlar O'zbekiston Respublikasi hududida oldindan to’lov tizimidagi barcha jismoniy shaxslar uchun amal qiladi. Paketlar «Shifokor», «Bolajon», «ProInternet 1GB» va «ProInternet 3GB» tarif rejalari uchun amal qilmaydi.\n" +
                        "- Barcha narxlar QQS bilan ko'rsatilgan."))
                list2.add(User2("5 gb"," *1*5#", "25.000 sum","- Oylik Internet-paketlarning amal qilish muddati paket yoqtirilgan kundan boshlab 30 kunni tashkil etadi. Internet-paket ulangan kundan boshlab 30 kun o'tgach yangi internet-paket yoqtirilmasa, ishlatilmagan trafik qoldig’i kuyadi.\n" +
                        "- Internet-paketning amal qilish muddati davomida yana qo'shimcha paket xarid qilinsa, barcha sarflanmagan trafik hajmi qo'shilib, amal qilish muddati oxirgi yoqtirilgan paket kunidan boshlab 30 kunga uzaytiriladi.\n" +
                        "- Taqdim etilgan trafik tugaganida yoki paket muddati yakunlanganda, internet-trafikning keyingi sarflanishi tarif rejangiz shartlariga muvofiq narxlanadi.\n" +
                        "- Raqam faol bo’lmagan yoki blok holatiga tushirilgan davrda oxirgi ulangan internet paketning amal qilish muddati o’zgarmaydi.\n" +
                        "- Shuni ma’lum qilamizki, internet trafik, daqiqa va SMSlar qoldig’i va boshqa qo’shimcha xizmatlar bo’yicha ma’lumoti 06:00 dan 00:00 gacha yuboriladi.\n" +
                        ...
                        "- Oylik internet paketlar O'zbekiston Respublikasi hududida oldindan to’lov tizimidagi barcha jismoniy shaxslar uchun amal qiladi. Paketlar «Shifokor», «Bolajon», «ProInternet 1GB» va «ProInternet 3GB» tarif rejalari uchun amal qilmaydi.\n" +
                        "- Barcha narxlar QQS bilan ko'rsatilgan."))
                list2.add(User2("10 gb", " *1*10#","45.000 sum","- Oylik Internet-paketlarning amal qilish muddati paket yoqtirilgan kundan boshlab 30 kunni tashkil etadi. Internet-paket ulangan kundan boshlab 30 kun o'tgach yangi internet-paket yoqtirilmasa, ishlatilmagan trafik qoldig’i kuyadi.\n" +
                        "- Internet-paketning amal qilish muddati davomida yana qo'shimcha paket xarid qilinsa, barcha sarflanmagan trafik hajmi qo'shilib, amal qilish muddati oxirgi yoqtirilgan paket kunidan boshlab 30 kunga uzaytiriladi.\n" +
                        "- Taqdim etilgan trafik tugaganida yoki paket muddati yakunlanganda, internet-trafikning keyingi sarflanishi tarif rejangiz shartlariga muvofiq narxlanadi.\n" +
                        "- Raqam faol bo’lmagan yoki blok holatiga tushirilgan davrda oxirgi ulangan internet paketning amal qilish muddati o’zgarmaydi.\n" +
                        "- Shuni ma’lum qilamizki, internet trafik, daqiqa va SMSlar qoldig’i va boshqa qo’shimcha xizmatlar bo’yicha ma’lumoti 06:00 dan 00:00 gacha yuboriladi.\n" +
                        ...
                        "- Oylik internet paketlar O'zbekiston Respublikasi hududida oldindan to’lov tizimidagi barcha jismoniy shaxslar uchun amal qiladi. Paketlar «Shifokor», «Bolajon», «ProInternet 1GB» va «ProInternet 3GB» tarif rejalari uchun amal qilmaydi.\n" +
                        "- Barcha narxlar QQS bilan ko'rsatilgan."))
                list2.add(User2("20 gb", "*1*20#","65.000 sum"," Oylik Internet-paketlarning amal qilish muddati paket yoqtirilgan kundan boshlab 30 kunni tashkil etadi. Internet-paket ulangan kundan boshlab 30 kun o'tgach yangi internet-paket yoqtirilmasa, ishlatilmagan trafik qoldig’i kuyadi.\n" +
                        "- Internet-paketning amal qilish muddati davomida yana qo'shimcha paket xarid qilinsa, barcha sarflanmagan trafik hajmi qo'shilib, amal qilish muddati oxirgi yoqtirilgan paket kunidan boshlab 30 kunga uzaytiriladi.\n" +
                        "- Taqdim etilgan trafik tugaganida yoki paket muddati yakunlanganda, internet-trafikning keyingi sarflanishi tarif rejangiz shartlariga muvofiq narxlanadi.\n" +
                        "- Raqam faol bo’lmagan yoki blok holatiga tushirilgan davrda oxirgi ulangan internet paketning amal qilish muddati o’zgarmaydi.\n" +
                        "- Shuni ma’lum qilamizki, internet trafik, daqiqa va SMSlar qoldig’i va boshqa qo’shimcha xizmatlar bo’yicha ma’lumoti 06:00 dan 00:00 gacha yuboriladi.\n" +
                        ...
                        "- Oylik internet paketlar O'zbekiston Respublikasi hududida oldindan to’lov tizimidagi barcha jismoniy shaxslar uchun amal qiladi. Paketlar «Shifokor», «Bolajon», «ProInternet 1GB» va «ProInternet 3GB» tarif rejalari uchun amal qilmaydi.\n" +
                        "- Barcha narxlar QQS bilan ko'rsatilgan."))
                list2.add(User2("30 gb", "*1*30#","75.000 sum","- Oylik Internet-paketlarning amal qilish muddati paket yoqtirilgan kundan boshlab 30 kunni tashkil etadi. Internet-paket ulangan kundan boshlab 30 kun o'tgach yangi internet-paket yoqtirilmasa, ishlatilmagan trafik qoldig’i kuyadi.\n" +
                        "- Internet-paketning amal qilish muddati davomida yana qo'shimcha paket xarid qilinsa, barcha sarflanmagan trafik hajmi qo'shilib, amal qilish muddati oxirgi yoqtirilgan paket kunidan boshlab 30 kunga uzaytiriladi.\n" +
                        "- Taqdim etilgan trafik tugaganida yoki paket muddati yakunlanganda, internet-trafikning keyingi sarflanishi tarif rejangiz shartlariga muvofiq narxlanadi.\n" +
                        "- Raqam faol bo’lmagan yoki blok holatiga tushirilgan davrda oxirgi ulangan internet paketning amal qilish muddati o’zgarmaydi.\n" +
                        "- Shuni ma’lum qilamizki, internet trafik, daqiqa va SMSlar qoldig’i va boshqa qo’shimcha xizmatlar bo’yicha ma’lumoti 06:00 dan 00:00 gacha yuboriladi.\n" +
                        ...
                        "- Oylik internet paketlar O'zbekiston Respublikasi hududida oldindan to’lov tizimidagi barcha jismoniy shaxslar uchun amal qiladi. Paketlar «Shifokor», «Bolajon», «ProInternet 1GB» va «ProInternet 3GB» tarif rejalari uchun amal qilmaydi.\n" +
                        "- Barcha narxlar QQS bilan ko'rsatilgan."))
                list2.add(User2("50 gb", "*1*50#","90.000 sum"," Oylik Internet-paketlarning amal qilish muddati paket yoqtirilgan kundan boshlab 30 kunni tashkil etadi. Internet-paket ulangan kundan boshlab 30 kun o'tgach yangi internet-paket yoqtirilmasa, ishlatilmagan trafik qoldig’i kuyadi.\n" +
                        "- Internet-paketning amal qilish muddati davomida yana qo'shimcha paket xarid qilinsa, barcha sarflanmagan trafik hajmi qo'shilib, amal qilish muddati oxirgi yoqtirilgan paket kunidan boshlab 30 kunga uzaytiriladi.\n" +
                        "- Taqdim etilgan trafik tugaganida yoki paket muddati yakunlanganda, internet-trafikning keyingi sarflanishi tarif rejangiz shartlariga muvofiq narxlanadi.\n" +
                        "- Raqam faol bo’lmagan yoki blok holatiga tushirilgan davrda oxirgi ulangan internet paketning amal qilish muddati o’zgarmaydi.\n" +
                        "- Shuni ma’lum qilamizki, internet trafik, daqiqa va SMSlar qoldig’i va boshqa qo’shimcha xizmatlar bo’yicha ma’lumoti 06:00 dan 00:00 gacha yuboriladi.\n" +
                        ...
                        "- Oylik internet paketlar O'zbekiston Respublikasi hududida oldindan to’lov tizimidagi barcha jismoniy shaxslar uchun amal qiladi. Paketlar «Shifokor», «Bolajon», «ProInternet 1GB» va «ProInternet 3GB» tarif rejalari uchun amal qilmaydi.\n" +
                        "- Barcha narxlar QQS bilan ko'rsatilgan."))
                list2.add(User2("75 gb", "*1*75#","110.000 sum","- Oylik Internet-paketlarning amal qilish muddati paket yoqtirilgan kundan boshlab 30 kunni tashkil etadi. Internet-paket ulangan kundan boshlab 30 kun o'tgach yangi internet-paket yoqtirilmasa, ishlatilmagan trafik qoldig’i kuyadi.\n" +
                        "- Internet-paketning amal qilish muddati davomida yana qo'shimcha paket xarid qilinsa, barcha sarflanmagan trafik hajmi qo'shilib, amal qilish muddati oxirgi yoqtirilgan paket kunidan boshlab 30 kunga uzaytiriladi.\n" +
                        "- Taqdim etilgan trafik tugaganida yoki paket muddati yakunlanganda, internet-trafikning keyingi sarflanishi tarif rejangiz shartlariga muvofiq narxlanadi.\n" +
                        "- Raqam faol bo’lmagan yoki blok holatiga tushirilgan davrda oxirgi ulangan internet paketning amal qilish muddati o’zgarmaydi.\n" +
                        "- Shuni ma’lum qilamizki, internet trafik, daqiqa va SMSlar qoldig’i va boshqa qo’shimcha xizmatlar bo’yicha ma’lumoti 06:00 dan 00:00 gacha yuboriladi.\n" +
                        ...
                        "- Oylik internet paketlar O'zbekiston Respublikasi hududida oldindan to’lov tizimidagi barcha jismoniy shaxslar uchun amal qiladi. Paketlar «Shifokor», «Bolajon», «ProInternet 1GB» va «ProInternet 3GB» tarif rejalari uchun amal qilmaydi.\n" +
                        "- Barcha narxlar QQS bilan ko'rsatilgan."))
                list2.add(User2("1.5 gb", "*1*0*5#","10.000 sum"," Haftalik Internet-paketlarning amal qilish muddati paket yoqtirilgan kundan boshlab 7 kunni tashkil etadi.\n" +
                        "- Taqdim etilgan trafik tugaganida yoki paket muddati yakunlanganda, internet-trafikning keyingi sarflanishi tarif rejangiz shartlariga muvofiq narxlanadi.\n" +
                        ...
                        "- Barcha narxlar QQS bilan ko'rsatilgan."))
                list2.add(User2("2.5 gb", "*1*0*6#","15.000 sum"," Haftalik Internet-paketlarning amal qilish muddati paket yoqtirilgan kundan boshlab 7 kunni tashkil etadi.\n" +
                        "- Taqdim etilgan trafik tugaganida yoki paket muddati yakunlanganda, internet-trafikning keyingi sarflanishi tarif rejangiz shartlariga muvofiq narxlanadi.\n" +
                        "- Internet-paketlar ketma-ket ulanganida ularning trafiki qo’shiladi. Trafikning amal qilish muddati etib ulangan paketlarning ichida eng maksimal muddat belgilanadi.\n" +
                        "- Raqam faol bo’lmagan yoki blok holatiga tushirilgan davrda oxirgi ulangan internet paketning amal qilish muddati o’zgarmaydi.\n" +
                        "- Shuni ma’lum qilamizki, internet trafik, daqiqa va SMSlar qoldig’i va boshqa qo’shimcha xizmatlar bo’yicha ma’lumoti 06:00 dan 00:00 gacha yuboriladi.\n" +
                        ...
                        "- Paketlar O'zbekiston Respublikasi hududida oldindan to’lov tizimidagi barcha jismoniy shaxslar uchun amal qiladi. Paketlar «Shifokor», «Bolajon», «ProInternet 1GB» va «ProInternet 3GB» tarif rejalari uchun amal qilmaydi.\n" +
                        "- Barcha narxlar QQS bilan ko'rsatilgan."))
                list2.add(User2("5.0 gb", "*1*0*7#","20.000 sum"," Haftalik Internet-paketlarning amal qilish muddati paket yoqtirilgan kundan boshlab 7 kunni tashkil etadi.\n" +
                        "- Taqdim etilgan trafik tugaganida yoki paket muddati yakunlanganda, internet-trafikning keyingi sarflanishi tarif rejangiz shartlariga muvofiq narxlanadi.\n" +
                        "- Internet-paketlar ketma-ket ulanganida ularning trafiki qo’shiladi. Trafikning amal qilish muddati etib ulangan paketlarning ichida eng maksimal muddat belgilanadi.\n" +
                        "- Raqam faol bo’lmagan yoki blok holatiga tushirilgan davrda oxirgi ulangan internet paketning amal qilish muddati o’zgarmaydi.\n" +
                        "- Shuni ma’lum qilamizki, internet trafik, daqiqa va SMSlar qoldig’i va boshqa qo’shimcha xizmatlar bo’yicha ma’lumoti 06:00 dan 00:00 gacha yuboriladi.\n" +
                        ...
                        "- Paketlar O'zbekiston Respublikasi hududida oldindan to’lov tizimidagi barcha jismoniy shaxslar uchun amal qiladi. Paketlar «Shifokor», «Bolajon», «ProInternet 1GB» va «ProInternet 3GB» tarif rejalari uchun amal qilmaydi.\n" +
                        "- Barcha narxlar QQS bilan ko'rsatilgan."))
                list2.add(User2("100 mb", "*1*0*1#","2.000 sum","- Kunlik Internet-paketlarning amal qilish muddati ulanish vaqtidan boshlab (keyingi kunni oxirigacha) 1 kunni tashkil etadi.\n" +
                        "- Taqdim etilgan trafik tugaganida yoki paket muddati yakunlanganda, internet-trafikning keyingi sarflanishi tarif rejangiz shartlariga muvofiq narxlanadi.\n" +
                        "- Internet-paketlar ketma-ket ulanganida ularning trafiki qo’shiladi. Trafikning amal qilish muddati etib ulangan paketlarning ichida eng maksimal muddat belgilanadi.\n" +
                        "- Raqam faol bo’lmagan yoki blok holatiga tushirilgan davrda oxirgi ulangan internet paketning amal qilish muddati o’zgarmaydi.\n" +
                        "- Shuni ma’lum qilamizki, internet trafik, daqiqa va SMSlar qoldig’i va boshqa qo’shimcha xizmatlar bo’yicha ma’lumoti 06:00 dan 00:00 gacha yuboriladi.\n" +
                        ...
                        "- Paketlar O'zbekiston Respublikasi hududida oldindan to’lov tizimidagi barcha jismoniy shaxslar uchun amal qiladi. Paketlar «Shifokor», «Bolajon», «ProInternet 1GB» va «ProInternet 3GB» tarif rejalari uchun amal qilmaydi.\n" +
                        "- Barcha narxlar QQS bilan ko'rsatilgan."))
                list2.add(User2("200 mb", "*1*0*2#","3.000 sum","- Kunlik Internet-paketlarning amal qilish muddati ulanish vaqtidan boshlab (keyingi kunni oxirigacha) 1 kunni tashkil etadi.\n" +
                        "- Taqdim etilgan trafik tugaganida yoki paket muddati yakunlanganda, internet-trafikning keyingi sarflanishi tarif rejangiz shartlariga muvofiq narxlanadi.\n" +
                        "- Internet-paketlar ketma-ket ulanganida ularning trafiki qo’shiladi. Trafikning amal qilish muddati etib ulangan paketlarning ichida eng maksimal muddat belgilanadi.\n" +
                        "- Raqam faol bo’lmagan yoki blok holatiga tushirilgan davrda oxirgi ulangan internet paketning amal qilish muddati o’zgarmaydi.\n" +
                        "- Shuni ma’lum qilamizki, internet trafik, daqiqa va SMSlar qoldig’i va boshqa qo’shimcha xizmatlar bo’yicha ma’lumoti 06:00 dan 00:00 gacha yuboriladi.\n" +
                        ...
                        "- Paketlar O'zbekiston Respublikasi hududida oldindan to’lov tizimidagi barcha jismoniy shaxslar uchun amal qiladi. Paketlar «Shifokor», «Bolajon», «ProInternet 1GB» va «ProInternet 3GB» tarif rejalari uchun amal qilmaydi.\n" +
                        "- Barcha narxlar QQS bilan ko'rsatilgan."))
                list2.add(User2("500 mb", "*1*0*3#","5.000 sum","- Kunlik Internet-paketlarning amal qilish muddati ulanish vaqtidan boshlab (keyingi kunni oxirigacha) 1 kunni tashkil etadi.\n" +
                        "- Taqdim etilgan trafik tugaganida yoki paket muddati yakunlanganda, internet-trafikning keyingi sarflanishi tarif rejangiz shartlariga muvofiq narxlanadi.\n" +
                        "- Internet-paketlar ketma-ket ulanganida ularning trafiki qo’shiladi. Trafikning amal qilish muddati etib ulangan paketlarning ichida eng maksimal muddat belgilanadi.\n" +
                        "- Raqam faol bo’lmagan yoki blok holatiga tushirilgan davrda oxirgi ulangan internet paketning amal qilish muddati o’zgarmaydi.\n" +
                        "- Shuni ma’lum qilamizki, internet trafik, daqiqa va SMSlar qoldig’i va boshqa qo’shimcha xizmatlar bo’yicha ma’lumoti 06:00 dan 00:00 gacha yuboriladi.\n" +
                        ...
                        "- Paketlar O'zbekiston Respublikasi hududida oldindan to’lov tizimidagi barcha jismoniy shaxslar uchun amal qiladi. Paketlar «Shifokor», «Bolajon», «ProInternet 1GB» va «ProInternet 3GB» tarif rejalari uchun amal qilmaydi.\n" +
                        "- Barcha narxlar QQS bilan ko'rsatilgan."))
                list2.add(User2("4 gb", "*1*0*4#","10.000 sum","- Kunlik Internet-paketlarning amal qilish muddati ulanish vaqtidan boshlab (keyingi kunni oxirigacha) 1 kunni tashkil etadi.\n" +
                        "- Taqdim etilgan trafik tugaganida yoki paket muddati yakunlanganda, internet-trafikning keyingi sarflanishi tarif rejangiz shartlariga muvofiq narxlanadi.\n" +
                        "- Internet-paketlar ketma-ket ulanganida ularning trafiki qo’shiladi. Trafikning amal qilish muddati etib ulangan paketlarning ichida eng maksimal muddat belgilanadi.\n" +
                        "- Raqam faol bo’lmagan yoki blok holatiga tushirilgan davrda oxirgi ulangan internet paketning amal qilish muddati o’zgarmaydi.\n" +
                        "- Shuni ma’lum qilamizki, internet trafik, daqiqa va SMSlar qoldig’i va boshqa qo’shimcha xizmatlar bo’yicha ma’lumoti 06:00 dan 00:00 gacha yuboriladi.\n" +
                        ...
                        "- Paketlar O'zbekiston Respublikasi hududida oldindan to’lov tizimidagi barcha jismoniy shaxslar uchun amal qiladi. Paketlar «Shifokor», «Bolajon», «ProInternet 1GB» va «ProInternet 3GB» tarif rejalari uchun amal qilmaydi.\n" +
                        "- Barcha narxlar QQS bilan ko'rsatilgan."))
                list2.add(User2("5 gb 4g", "*110*58#","10.000 sum","«4G KUN» internet-paketi ulanish vaqtidan boshlab 1 kun davomida amal qiladi (keyingi kunni oxirigacha).\n" +
                        "\n" +
                        ...
                        "\n" +
                        "Barcha narxlar QQS bilan ko'rsatilgan."))
                list2.add(User2("15 gb 4g", "*110*62#","30.000 sum","«4G Hafta» internet-paketi yoqilgan paytdan boshlab 7 kun amal qiladi.\n" +
                        "\n" +
                        "«4G Kun», «4G Hafta» va «4G Oy» paketlari faqat 4G tarmog'ida amal qiladi va 2G/3G tarmoqlarida sarflanmaydi. 4G tarmog'iga ulanganda birinchi navbatda 4G internet-paketlarining trafiki sarflanadi.\n" +
                        "\n" +
                        "4G tarmog'idan 3G yoki 2G tarmog'iga o'tilganda, trafik qo'shimcha paket bo'lmaganda, asosiy balansdan sarflanadi. 3G yoki 2G tarmog'iga ulanish 4G tarmog'i qoplanmagan hududlarda va ovozli qo'ng'iroq vaqtida amalga oshadi.\n" +
                        ...
                        "\n" +
                        "Barcha narxlar QQS bilan ko'rsatilgan."))
                list2.add(User2("30 gb 4g", "*110*59#","60.000 sum","«4G OY» internet-paketi yoqilgan paytdan boshlab 30 kun amal qiladi.\n" +
                        "\n" +
                        "«4G Kun», «4G Hafta» va «4G Oy» paketlari faqat 4G tarmog'ida amal qiladi va 2G/3G tarmoqlarida sarflanmaydi. 4G tarmog'iga ulanganda birinchi navbatda 4G internet-paketlarining trafiki sarflanadi.\n" +
                        "\n" +
                        "4G tarmog'idan 3G yoki 2G tarmog'iga o'tilganda, trafik qo'shimcha paket bo'lmaganda, asosiy balansdan sarflanadi. 3G yoki 2G tarmog'iga ulanish 4G tarmog'i qoplanmagan hududlarda va ovozli qo'ng'iroq vaqtida amalga oshadi.\n" +
            ...
            3 ->{
                ...
                binding.imageBacObshiy3.visibility = View.INVISIBLE
                binding.imageBacObshiy4.visibility = View.INVISIBLE
                list3.add(User3("Aksiya 40gb", "*110*568#","30.000 sum","- «7 kunga 40 GB» paketi yoqilgan paytdan boshlab 7 kun amal qiladi va 7 kun o'tganidan so'ng, sarflanmagan trafik qoldig’i kuyadi.\n" +
                        "\n" +
                        ...
                        "\n" +
                        "- Barcha narxlar QQS bilan ko'rsatilgan."))
                list3.add(User3("Aksiya 150gb","*110*562#", "90.000 sum","- «30 kunga 150 GB» paketi yoqilgan paytdan boshlab 30 kun amal qiladi va 30 kun o'tganidan so'ng, sarflanmagan trafik qoldig’i kuyadi.\n" +
                        "\n" +
                        ...
                        "\n" +
                        "- Barcha narxlar QQS bilan ko'rsatilgan."))
                list3.add(User3("Aksiya 100gb"," *110*561#", "15.000 smm","- «1 kunga 100 GB» paketi amal qilish muddati ulanish vaqtidan boshlab 1 kunni (keyingi kunni oxirigacha) tashkil etadi va muddati tugaganidan so’ng sarflanmagan trafik qoldig’I kuyadi.\n" +
                        "\n" +
                        ...
                        "\n" +
                        "- Barcha narxlar QQS bilan ko'rsatilgan.",))
                list3.add(User3("Plus 7", "*110*63#","4.900 sum","300 min", "300 sms","•    «PLUS» paketlariga «Terminal»,«Tuner», «Electronics» tarif rejalaridan tashqari, oldindan to’lov tizimining qolgan barcha tarif rejalaridagi abonentlar uchun ulanish imkoniyati mavjud.\n" +
                ...
                list3.add(User3("Plus 14","*110*64#", "9.900 sum","1000 min", "1000 sms","•    «PLUS» paketlariga «Terminal»,«Tuner», «Electronics» tarif rejalaridan tashqari, oldindan to’lov tizimining qolgan barcha tarif rejalaridagi abonentlar uchun ulanish imkoniyati mavjud.\n" +
                        "•   Istalgan vaqtda «PLUS» paketlariga ulanishingiz va aloqa xizmatlaridan qulay narxlarda foydalanishingiz mumkin!    \n" +
                        "•   «PLUS 7» yoki «PLUS 14» paketlari qayta ulanganida avvalgi «PLUS» paketida sarflanmay qolgan qoldiq yangi ulangan «PLUS» paketining qoldig'iga qo'shilib ketadi. Avvalgi va yangi ulangan paketlarning qaysi birining amal qilish muddati kattaroq bo'lsa o'sha muddat qoldiq amal qilish muddati etib belgilanadi.    \n" +
                        "•   «PLUS» turkumidagi paketlar amal qilish muddati tugaguncha, yangi «PLUS» paketi yoqtirilmasa, amal qilish muddati tugashi bilan ishlatilmagan trafik kuyadi.    \n" +
                        "•   Taqdim etilgan trafik tugaganida yoki paket muddati nihoyasiga yetganda, aloqa xizmatlaridan keyingi foydalanish tarif rejangiz shartlariga muvofiq narxlanadi.    \n" +
                        ...
                        "•   Kontent xizmatlariga va axborot xizmatlariga bo'lgan qo'ng'iroqlar, «PLUS» turkumidagi daqiqa paketidan sarflanmaydi.    \n" +
                        "•   Aloqa telekommunikatsiya kanallarini eng optimal usulda ishlatish, shuningdek, Abonentning manfaatlarini ularning qurilmalaridan beruxsat foydalanishidan himoyalash maqsadida, Kompaniya ovozli xizmatlar uchun bir ulanishning davomiyligini 40 daqiqa etib belgilaydi."))
                list3.add(User3("Erkin Muloqot","*110*230#", "8.400 sum","500 min,200 mb","500 sms","Shuni ma’lum qilamizki, internet-trafik, tariflar uchun daqiqalar va SMS-xabarlar, shuningdek boshqa qo'shimcha xizmatlar qoldig’i haqida ma'lumot berish 06:00 dan 00:00 gacha qabul qilinadi.\n" +
                        "\n" +
                        ...
                        "\n" +
                        "Xizmatga ulanish kodi: *5#."))
                list3.add(User3("Erkin Muloqot+","*110*225#", "12.600 sum","- Shuni ma’lum qilamizki, internet-trafik balansi, paketlar va tariflar uchun daqiqalar va SMS-xabarlar, shuningdek boshqa qo'shimcha xizmatlar uchun ma'lumot berish 06:00 dan 00:00 gacha qabul qilinadi.\n" +
                ...
                list3.add(User3("Beeline app","", "1.300/kun 25.000/oy","- Xizmat oldindan to'lov tizimidagi tarif rejalari abonentlari uchun amal qiladi.\n" +
                ...
                list3.add(User3("Beeline Visa","", "10.000 sum","Beeline Uzbekistan Ravnaq Bank bilan hamkorlikda «Beeline VISA» xizmatini ishga tushiradi, bu esa Beeline abonentlariga uydan chiqmagan holda VISA virtual kartasini ochish orqali bank xizmatidan foydalanish imkonini beradi.\n" +
                        "\n" +
                ...
                list3.add(User3("Imo 20 paketi","*110*45#", "5.000","20 soat","«IMO 20» internet paketi oldindan to'lov tizimining barcha tariflari uchun amal qiladi («Bolajon» tarifida va «ProInternet» tarif rejalari turkumidan tashqari).\n" +
                        "\n" +
            ...
            4 ->{
                ...
                list4.add(User4("Paket 100 sms","*110*06#", "3.500 sum","Mahalliy SMS-paketlar O'zbekistonning barcha uyali aloqa operatorlariga jo'natilishi mumkin.\n" +
                        "\n" +
                ...
                list4.add(User4("Paket 500 sms", "*110*06#","11.000 sum","Mahalliy SMS-paketlar O'zbekistonning barcha uyali aloqa operatorlariga jo'natilishi mumkin.\n" +
                        "\n" +
                        "SMS bilan siz quyidagilarni amalga oshirishingiz mumkin:\n" +
                        "\n" +
                        "bir vaqtning o'zida bir necha kishiga muhim ma'lumotlarni yuborish;\n" +
                        ...
                        "Xizmatni yoqish yoki o’chirish uchun Korporativ Abonentlarga xizmat ko’rsatish bo’limiga yozma ko’rinishda ariza berish, 0611@beeline.uz manziliga jo’natish lozim;\n" +
                        "Barcha narxlar QQS hisobga olinmagan holda ko'rsatilgan."))
                list4.add(User4("Paket 1000 sms", "*110*06#","17.555 sum","Mahalliy SMS-paketlar O'zbekistonning barcha uyali aloqa operatorlariga jo'natilishi mumkin.\n" +
                        "\n" +
                        "SMS bilan siz quyidagilarni amalga oshirishingiz mumkin:\n" +
                        "\n" +
                        "bir vaqtning o'zida bir necha kishiga muhim ma'lumotlarni yuborish;\n" +
